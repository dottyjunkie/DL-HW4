...
print(inputs.get_shape().as_list()) # [None, 27]
print(date_input_embed.get_shape().as_list()) # [None, 27, 10]
...
for epoch_i in range(epochs):
    ...
    for batch_i, (source_batch, target_batch) in enumerate(batch_data(X_train, y_train, batch_size)):
        # print(source_batch.shape) # (128,27)
        # print(target_batch.shape) # (128,11)
