    ...
    def build_model(self):
        ...
        def build_cell(X, weights, biases):
            ...
            if self.cell == 'SimpleRNN':
                ...
                # print('*****************')
                # print(outputs)          # Tensor("rnn/transpose_1:0", shape=(128, 28, 128), dtype=float32)
                # print(final_state)      # Tensor("rnn/while/Exit_3:0", shape=(128 batch, 128 hidden), dtype=float32) 
                # print('*****************')
                ...
                # print('*****************')
                # print(cell.state_size) # LSTMStateTuple(c=128, m=128)
                # print('*****************')
                ...
                # print('*****************')
                # print(outputs)              # Tensor("rnn/transpose_1:0", shape=(128, 28, 128), dtype=float32)
                # print(final_state.h)        # Tensor("rnn/while/Exit_4:0", shape=(128, 128), dtype=float32) 
                # print(final_state.c)        # Tensor("rnn/while/Exit_3:0", shape=(128, 128), dtype=float32)
                # print(final_state[1].shape) # (128, 128)
                # print('*****************')
